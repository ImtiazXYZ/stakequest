...
const StatsAndTournaments = () => {
  ...
  return (
    <>
      ...
      {/* Stats Section */}
      <div className="space-bottom counter-area-1" style={{ padding: '60px 0', backgroundColor: '#1a1a1a' }}>
        <div className="container" style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div className="counter-card-wrap">
            <div className="counter-card" style={{ animationDelay: '0.1s' }}>
              <div className="media-body">
                <h2 className="box-number">
                  <span className="counter-number" ref={el => counterRefs.current[0] = el}>1.6</span>K
                  <span className="text-theme fw-medium">+</span>
                </h2>
                <p className="box-text">Our Daily Game Users</p>
              </div>
            </div>
            <div className="counter-card" style={{ animationDelay: '0.3s' }}>
              <div className="media-body">
                <h2 className="box-number">
                  <span className="counter-number" ref={el => counterRefs.current[1] = el}>50</span>M
                </h2>
                <p className="box-text">Game Downloads</p>
              </div>
            </div>
            <div className="counter-card" style={{ animationDelay: '0.5s' }}>
              <div className="media-body">
                <h2 className="box-number">
                  <span className="counter-number" ref={el => counterRefs.current[2] = el}>200</span>
                  <span className="text-theme fw-medium">+</span>
                </h2>
                <p className="box-text">Game Launched</p>
              </div>
            </div>
            <div className="counter-card" style={{ animationDelay: '0.7s' }}>
              <div className="media-body">
                <h2 className="box-number">
                  <span className="counter-number" ref={el => counterRefs.current[3] = el}>3.6</span>M
                </h2>
