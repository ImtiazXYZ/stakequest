    ...
    <section id="blog-sec" style={styles.section}>
      ...
      <div style={styles.container}>
        <div style={styles.titleArea}>
          <span style={styles.subTitle}># Game Updates & News</span>
          <h2 style={styles.secTitle}>
            Stay Updated With StakeQuest Legends <span style={styles.textTheme}>!</span>
          </h2>
        </div>
        ...
        <div style={styles.sliderArea}>
          <div style={{ ...styles.sliderWrapper }}>
            {blogs.map((blog, index) => (
              <div key={blog.id} style={{ animationDelay: blog.delay }}>
                <div style={styles.blogCard}>
                  ...
                  <div style={styles.blogContent}>
                    <div style={styles.blogMeta}>
                      <a href="blog.html"><i className="far fa-user"></i>{blog.author}</a>
                      <a href="blog.html"><i className="far fa-calendar"></i>{blog.date}</a>
                    </div>
                    <h3 style={styles.blogTitle}>
                      <a href="blog-details.html">{blog.title}</a>
                    </h3>
                    <a href="blog-details.html" style={styles.linkBtn}>
